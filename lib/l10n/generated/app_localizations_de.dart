...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get dashboardWeekLegendIntro =>
      'Die Punkte unter den Wochentagen zeigen an, ob du an diesem Tag Kraft, Ausdauer oder beides trainiert hast.';
  ...
  String get dashboardMotivationTeaser =>
      'Brauchst du einen Schubs? Hier ist dein Spruch des Tages.';

  @override
  String get dashboardQuoteOne =>
      'WIRF DAS HANDTUCH NIE. NUTZE ES, UM DEN SCHWEISS ABZUWISCHEN. UND MACH WEITER.';

  @override
  String get dashboardQuoteTwo =>
      'Disziplin bedeutet, das zu wählen, was du wirklich willst, statt das, was du gerade willst.';

  @override
  String get dashboardQuoteThree =>
      'Kleine Schritte, konsequent umgesetzt, werden zu großen Ergebnissen.';

  @override
  String get dashboardQuoteFour =>
      'Motivation startet dich. Routine trägt dich weiter.';

  @override
  String get dashboardQuoteFive =>
      'Dein zukünftiges Ich wird dir für die heutige Einheit danken.';
  ...
  String get dashboardShareQuoteDialogMessage =>
      'Teile dieses Motivationszitat mit einer Freundin oder einem Freund.';
  ...
  String get dashboardShareQuoteIntro =>
      'Ein Freund denkt, du solltest trainieren.';

  @override
  String get dashboardShareQuoteCopied =>
      'Motivation in die Zwischenablage kopiert.';
  ...
  String get dashboardStepsGoalDialogMessage =>
      'Lege dein tägliches Schrittziel fest.';
  ...
  String get streakInfoDescription =>
      'Für jeden Monat, in dem du dein persönliches Kraft- oder Ausdauerziel erreichst, bekommst du einen Stern. Diese Ziele kannst du in den entsprechenden Dashboard-Kacheln anpassen.';
  ...
  String get dashboardQuickStartStrengthSubtitle =>
      'Starte deine nächste Krafteinheit.';

  @override
  String get dashboardQuickStartEnduranceSubtitle =>
      'Öffne Ausdauer mit Fallback-Kachel.';
  ...
  String get dashboardGymKnowledgeSubtitle =>
      'Evidenzbasierte Inhalte und praktische Impulse.';
  ...
  String get dashboardYoutubeItemOneSubtitle =>
      'Grundlagen aus der Leistungsphysiologie.';
  ...
  String get dashboardYoutubeItemTwoSubtitle =>
      'Warum dasselbe Training später weniger schmerzt.';
  ...
  String get dashboardYoutubeUnavailable =>
      'Zurzeit sind keine Videos verfügbar.';
  ...
  String get dashboardYoutubeOpenFailed =>
      'YouTube konnte nicht geöffnet werden.';
}
