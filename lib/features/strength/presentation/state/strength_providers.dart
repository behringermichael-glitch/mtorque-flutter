...
final strengthPlanPrintServiceProvider = Provider<StrengthPlanPrintService>((
  ref,
) {
  final repository = ref.watch(strengthRepositoryProvider);

  return StrengthPlanPrintService(repository: repository);
});

final strengthPlanShareServiceProvider = Provider<StrengthPlanShareService>((
  ref,
) {
  final repository = ref.watch(strengthRepositoryProvider);

  return StrengthPlanShareService(repository: repository);
});
